export default {
  ...
  complementario: [
    {
      tema: 'Elaboración de panela',
      referencia:
        'Rojas, G. (2016, enero 17). Elaboración Papelón / Panela [Video]. Youtube. ',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'TvAgro. (2019, marzo 12). Cuál es el Proceso de Elaboración de la Panela [Video]. Youtube. ',
      tipo: 'Video ',
      link: 'https://www.youtube.com/watch?v=hgUj0tKM8OA',
    },
    {
      tema: 'Hornillas paneleras eficientes',
      referencia:
        'AEA Región Andina. (2014, diciembre 8). Hornillas paneleras eficientes [Video]. Youtube. ',
      tipo: 'Video',
      link: 'https://www.youtube.com/watch?v=01jkgR9jotM',
    },
    {
      tema: 'Maestro constructor de hornillas paneleras',
      referencia:
  ...
  referencias: [
    ...
    {
      referencia:
        'Agricultura & Ganadería (s. f.). Aumentando la eficiencia energética en los trapiches paneleros del país. Periódico virtual especializado en noticias del sector agropecuario. Recuperado 10 de octubre de 2022, de',
      link:
        'https://www.agriculturayganaderia.com/website/aumentando-la-eficiencia-energetica-en-los-trapiches-paneleros-del-pais/',
    },
    {
      referencia:
        'Cabello, M., Cabello, J., Moya, J., Goytisolo, R., Velásquez, J., & Mestizo, J. (2012). Modelación matemática de la flotación de la maza superior de los molinos de caña de azúcar. Ingeniería Mecánica, 15(1), 44-53. ',
      link:
        'http://scielo.sld.cu/scielo.php?script=sci_abstract&pid=S1815-59442012000100005&lng=es&nrm=iso&tlng=es',
    },
    {
      referencia:
        'Cristancho, A. (2012). Diseño de un sistema de recirculación de gases en hornillas paneleras de evaporación abierta usando EES. [Proyecto de grado para optar al título de Ingeniera Mecánica, Universidad de los Andes]. ',
      link:
        'https://repositorio.uniandes.edu.co/bitstream/handle/1992/14973/u615569.pdf?sequence=1  ',
    },
    {
      referencia:
        'Deantonio, L. Ospina, C., Varó, V., & Lópe, X. (2020). Tecnologías para el sector panelero. ',
      link: 'https://doi.org/10.21930/agrosavia.brochure.7403534',
    },
    {
      referencia:
        'Espinoza, G. (2017). Estudio fluidodinámico y estructural de pailas paneleras pirotubulares [Tesis de pregrado en Ingeniería Mecánico-Eléctrica. Universidad de Piura, Facultad de Ingeniería. Programa Académico de Ingeniería Mecánico-Eléctrica. Piura, Perú]. ',
      link: 'https://pirhua.udep.edu.pe/handle/11042/2736',
    },
    {
      referencia:
        'Fernández del Campo, L. (1901). Cultivo de la caña de azúcar. Serie: Biblioteca Agrícola de la Secretaría de Fomento, digitalizado en 2012. ',
      link: 'https://doi.org/10.5962/bhl.title.156871 ',
    },
    {
      referencia:
        'García, H. (2020). Curso básico descriptivo para el diseño, construcción y operación de hornillas paneleras. Fedepanela. ',
      link: 'http://www.sipa.org.co/wp/wp-content/uploads/Tema1_Hornillas.pdf ',
    },
    {
      referencia:
        'Gottret, M. & Rodríguez, G. (2018). Aprendiendo del pasado para proyectarnos hacia el futuro: adopción e impacto de la tecnología de panela en la hoya del río Suárez y Cundinamarca (Colombia). Informe Técnico, CORPOICA, & CIAT. ',
      link:
        'https://repository.agrosavia.co/bitstream/handle/20.500.12324/12342/44660_59329.pdf?sequence=1&isAllowed=y',
    },
    {
      referencia:
        'Hernández, S., Cely, M. & Torres, Z. (2018) Capacidades y tendencias tecnológicas en el proceso de producción de panela artesanal. Un estudio de vigilancia tecnológica. Revista científica profundidad construyendo futuro, 15(15), 49¬-63.  ',
      link: 'https://doi.org/10.22463/24221783.3310',
    },
    {
      referencia:
        'Mendieta, O. & Escalante, H. (2013). Análisis experimental de la evaporación del jugo de caña de azúcar en película sobre una placa plana. Ciencia y Tecnología Agropecuaria,14 (2), 113–127. ',
      link:
    ...
    {
      referencia:
        'Moreno, J., Castrillón, N. & Zuluaga, C. (2017). Procesamiento en paralelo y distribuido en dos SGBDS: un caso de estudio. Revista Tecnura, 21(52), 111–129. ',
      link: 'https://doi.org/10.14483/udistrital.jour.tecnura.2017.2.a09 ',
    },
    {
      referencia:
        'Morales, V., Osorio, A. & Rodríguez, J. (2017). Innovaciones en el trapiche panelero: la producción de panela granulada. Agroproductividad, 10(11), 41– 47. ',
      link:
        'https://link.gale.com/apps/doc/A530914345/IFME?u=anon~3b9335c6&sid=googleScholar&xid=9e5d814c',
    },
    {
      referencia:
        'Osorio, G. 2007a). Manual técnico buenas prácticas agrícolas (BBA) y buenas prácticas de manufactura (BPM) en la producción de caña y panela. ',
      link:
        'https://repository.agrosavia.co/bitstream/handle/20.500.12324/18313/43120_50541.pdf?sequence=1&isAllowed=y',
    },
    {
      referencia:
        'Osorio, G. (2007b). Manual técnico buenas prácticas agrícolas (BBA) y buenas prácticas de manufactura (BPM) en la producción de caña y panela. Extracción de jugos, (Tabla 22). Organización de las Naciones Unidas para la Agricultura y la Alimentación (FAO). ',
      link: 'https://www.fao.org/3/a1525s/a1525s00.pdf',
    },
    {
      referencia:
        'Prada, L. (2002). Mejoramiento en la calidad de miel y panela. Recuperado de: ',
      link: 'http://hdl.handle.net/20.500.12324/17691  ',
    },
    {
      referencia:
        'Prada, L., García, H. & Chaves, A. (2015). Efecto de las variables de evaporación: presión y flujo calórico en la calidad de la panela. Ciencia y Tecnología Agropecuaria, 16(1), 7–23. ',
      link:
    ...
    {
      referencia:
        'Quezada, W. (2007). Guía técnica de agroindustria panelera.  ',
      link:
        'http://repositorio.utn.edu.ec/bitstream/123456789/934/1/GuíaTécnicadeAgroindustriaPanelera.pdf ',
    },
    {
      referencia:
        'Rodríguez, J. (2017). Innovaciones en el trapiche panelero: la producción de panela granulada. Agroproductividad, 10(11). ',
      link:
        'https://revista-agroproductividad.org/index.php/agroproductividad/article/view/67 ',
    },
    {
      referencia:
        'Romero, E., Scandaliaris, J., Digonzelli, P., Leggio, M., Giardina, J., Fernández, J., Casen, S., Tonatto, M. & Alonso, L.  (2009). La caña de azúcar, características y ecofisiología. ',
      link:
        'https://www.researchgate.net/publication/284772525_La_cana_de_azucar_caracteristicas_y_ecofisiologia',
    },
    {
      referencia:
        'Ruiz, I., Melo, L., Ramírez, L. & Blanco, X. (2019). Implementación tecnológica en proceso de fabricación de panela orgánica para cubrir demanda española. Institución Universitaria Politécnico Grancolombiano. ',
      link:
    ...
    {
      referencia:
        'Sánchez, A. (2018, noviembre 8). Trapiche, Molino para caña de azúcar [Video]. Youtube. ',
      link: 'https://www.youtube.com/watch?v=sYV_5L0AKoI',
    },
    {
      referencia:
        'Vargas, R. (2019). Zonificación de la Hoya del Río Suárez por propiedades físicas del suelo, para el cultivo de caña panelera [Tesis Maestría, Universidad Nacional]. ',
